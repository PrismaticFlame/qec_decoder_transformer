#!/usr/bin/env python3
"""
eval_combine.py - Evaluate separate X/Z models and compute combined LER (trans6)
...
def evaluate_distance(
    ...
    for basis in ["z", "x"]:
        ...
        # Build model (using local builder to avoid trans3/trans6 import collision)
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate separate X/Z models and compute combined LER (trans6)",
